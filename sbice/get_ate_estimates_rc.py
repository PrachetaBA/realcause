...
def load_smcabc(dataset_name,
    ...
    if not observed_data:
        ...
        param_mapping = {
            f'{prefix}te': 'te', f'{prefix}deg_hetero': 'deg_hetero', f'{prefix}overlap': 'overlap'
        }
...
if __name__ == '__main__':
    ...
    if args.observed_data:
        ...
        observed_data = load_smcabc(
            dataset_name=args.dataset_name,
            dataset_identifier=args.dataset_identifier,
            sample_size=args.sample_size,
            dataset_path=
            f'data/smc_abc/{args.dataset_name}_{args.dataset_identifier}_{args.sample_size}_dist_{args.distance_function}_expt_{args.experiment_number}/1',
            dataset_number=0,
            observed_data=True,
            posterior_or_prior=None,
