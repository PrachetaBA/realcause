...
```sbatch cluster/scripts/tune_hyperparameters_comet.sh --data <data_name> --data_identifier <id> --sample_size <ss> --saveroot <results/exp_name>``` and include any other corresponding arguments. 
