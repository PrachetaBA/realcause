...
if [ "$type_of_run" == "source" ]; then
    python -u -m sbice.get_ate_estimates --dataset_name $2 --dataset_identifier $3 --sample_size $4 --observed_data --set_of_estimators $5 --experiment_number $6 --realcause_model_path $7
elif [ "$type_of_run" == "generated" ]; then
    python -u -m sbice.get_ate_estimates --dataset_name $2 --dataset_identifier $3 --sample_size $4 --set_of_estimators $5 --experiment_number $6 --posterior_or_prior $7 --realcause_model_path $8
else
