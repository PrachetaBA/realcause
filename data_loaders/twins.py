...
import sys
import pandas as pd
from utils import download_dataset, NUMPY, PANDAS
from consts import REALCAUSE_DATASETS_FOLDER

sys.path.append(REALCAUSE_DATASETS_FOLDER)
...
def load_twins(dataroot=REALCAUSE_DATASETS_FOLDER, data_format=NUMPY,
...
if __name__ == '__main__':
    ...
    # d = load_twins(data_format='numpy', return_sketchy_ites=True, return_sketchy_ate=True)
    # print(d['ites'])
    # print(d['ate'])
    # print(d['w'])
    # print(d['t'])
    ...
    # Test pandas loading
    d = load_twins(data_format = 'pandas')
